            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center">
                        <img src="<?php echo e(asset('icons/reso.png')); ?>" alt="Platform Logo" class="block h-20 w-auto">
                    </a>
                </div>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <img src="<?php echo e($avatarUrl); ?>" alt="<?php echo e(Auth::user()->name); ?>'s Avatar" class="h-8 w-8 rounded-full object-cover me-2">
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4 flex items-center space-x-3">
                <img src="<?php echo e($avatarUrl); ?>" alt="<?php echo e(Auth::user()->name); ?>'s Avatar" class="h-10 w-10 rounded-full object-cover">
...
<?php /**PATH C:\laragon\www\musicsocial-main\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>