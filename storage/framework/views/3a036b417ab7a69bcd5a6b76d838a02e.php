        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-12 gap-6 md:gap-8">
            ...
            <div class="col-span-12 md:col-span-7">
                <div class="p-6 text-gray-900">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recommendedShares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $share): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
