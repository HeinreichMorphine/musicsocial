        ...
        <div class="col-md-8">
            <div class="panel-card">
                <div class="panel-head">
                    <h4><i class="fa fa-info-circle" style="color:#3b82f6;margin-right:6px;"></i> Core Metadata</h4>
                </div>
                <div style="padding: 1.5rem;">
                    <div class="form-group mb-4">
                        <label for="track_name">Song Title <span class="text-danger">*</span></label>
                        <input type="text" id="track_name" name="track_name" class="form-control" value="{{ old('track_name') }}" required placeholder="e.g. Bohemian Rhapsody">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" id="artist_name" name="artist_name" class="form-control" value="{{ old('artist_name') }}" required placeholder="e.g. Queen">
                    ...
                    <div class="form-group mb-4" x-data="tagInput('{{ old('genres') }}')">
                        <label for="genres">Genres / Tags</label>
                        
                        <!-- Hidden input to submit the actual comma-separated string -->
        ...
        <div class="col-md-4">
            <div class="panel-card">
                ...
                <div style="padding: 1.5rem;">
                    <div class="form-group mb-4">
                        ...
                        <input type="url" id="album_art_url" name="album_art_url" class="form-control" value="{{ old('album_art_url') }}" placeholder="https://...">
                        <p class="help-block">External link to the album cover image.</p>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" id="spotify_track_id" name="spotify_track_id" class="form-control" value="{{ old('spotify_track_id') }}" placeholder="e.g. 4PTG3Z6ehGkBFwjyBzWkR8">
                        <p class="help-block">Crucial for rendering rich share cards. You can paste the full URL.</p>
                        @error('spotify_track_id') <span class="text-danger text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="form-group mb-4">
                        <label for="youtube_url">YouTube Video URL</label>
                        <input type="url" id="youtube_url" name="youtube_url" class="form-control" value="{{ old('youtube_url') }}" placeholder="https://youtube.com/watch?v=...">
                        <p class="help-block">Used for alternative video streams.</p>
            ...
            <div class="panel-card">
                <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 12px;">
                    <button type="submit" class="btn-save"><i class="fa fa-save"></i> Save Song</button>
