...
<style>
    ...
    .kpi-label { font-size: 0.72rem; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: .5px; margin-top: 2px; }

    .panels-row { display: grid; grid-template-columns: 2fr 1fr; gap: 1rem; margin-bottom: 1rem; }
    .panel-card {
    ...
    .panel-head h4 { font-size: .85rem; font-weight: 700; color: #0f172a; margin: 0; }
    .panel-head small { font-size: .72rem; color: #94a3b8; }
    ...
    .genre-count { background: #eff6ff; color: #1d4ed8; font-weight: 700; font-size: .72rem; padding: .2rem .55rem; border-radius: 20px; }
    ...
    .user-info-name { font-size: .83rem; font-weight: 600; color: #0f172a; }
    .user-info-email { font-size: .72rem; color: #94a3b8; }
    .user-time { font-size: .7rem; color: #cbd5e1; margin-left: auto; white-space: nowrap; }
    ...
    .share-song { font-size: .83rem; font-weight: 600; color: #0f172a; }
    .share-meta { font-size: .72rem; color: #94a3b8; }
    .share-time { font-size: .7rem; color: #cbd5e1; margin-left: auto; white-space: nowrap; }
