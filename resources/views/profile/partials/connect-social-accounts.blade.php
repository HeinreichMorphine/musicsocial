    ...
    <div class="mt-6 space-y-6">
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="font-medium text-gray-900">Spotify</h3>
            ...
            <div>
                 @if(Auth::user()->spotify_id)
                    <button disabled class="px-4 py-2 bg-gray-100 text-gray-400 rounded-md text-sm font-medium cursor-not-allowed">
                        Connected
                    </button>
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="font-medium text-gray-900">Google / YouTube</h3>
