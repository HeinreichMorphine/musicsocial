<x-app-layout pageTitle="Home Feed">
    ...
    <div x-data="{ isMusicShareModalOpen: false }">
        ...
        <!-- Hero Share Section -->
        <div class="w-full bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-black py-16 mb-8 border-b border-gray-200 dark:border-white/5">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-12 gap-6 md:gap-8">
                ...
                <div class="hidden md:block col-span-2">
                    <div class="sticky top-24 pt-4">
                        <div class="bg-white/60 dark:bg-black backdrop-blur-lg rounded-3xl p-6 border border-white/40 dark:border-white/10 shadow-xl transition-colors duration-300">
