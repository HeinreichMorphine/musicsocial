            ...
            <div class="col-span-12 md:col-span-8 lg:col-span-6 xl:col-span-7 space-y-8">
                ...
                <div x-data="{ isCollapsed: localStorage.getItem('playlistOnboardingCollapsed') === 'true' }" class="space-y-4">
                    ...
                    <div x-show="isCollapsed" 
                         ...
                         class="relative bg-white dark:bg-[#111113] border border-gray-200 dark:border-zinc-800 rounded-2xl px-5 py-3.5 cursor-pointer hover:border-gray-300 dark:hover:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-900/40 transition-all duration-300 flex items-center justify-between shadow-md group/collapsed"
                    >
                    ...
                    <div x-show="!isCollapsed"
                         ...
                         class="relative bg-white dark:bg-[#111113] border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-xl overflow-hidden group/banner"
                    >
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="bg-gray-50 dark:bg-zinc-900/60 border border-gray-100 dark:border-zinc-800 rounded-2xl p-5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-gray-100/50 dark:hover:bg-zinc-900 transition-all duration-300 flex flex-col items-start">
                                ...
                                <div class="bg-gray-50 dark:bg-zinc-900/60 border border-gray-100 dark:border-zinc-800 rounded-2xl p-5 hover:border-fuchsia-500/30 dark:hover:border-fuchsia-500/30 hover:bg-gray-100/50 dark:hover:bg-zinc-900 transition-all duration-300 flex flex-col items-start">
                                ...
                                <div class="bg-gray-50 dark:bg-zinc-900/60 border border-gray-100 dark:border-zinc-800 rounded-2xl p-5 hover:border-emerald-500/30 dark:hover:border-emerald-500/30 hover:bg-gray-100/50 dark:hover:bg-zinc-900 transition-all duration-300 flex flex-col items-start">
