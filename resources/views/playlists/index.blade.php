            ...
            <div class="col-span-12 md:col-span-8 lg:col-span-6 xl:col-span-7 space-y-8">
                ...
                <div x-data="{ isCollapsed: localStorage.getItem('playlistOnboardingCollapsed') === 'true' }" class="space-y-4">
                    ...
                    <div x-show="isCollapsed" 
                         ...
                         class="relative bg-white dark:bg-black border border-gray-200 dark:border-white/10 rounded-2xl px-5 py-3.5 cursor-pointer hover:border-gray-300 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-all duration-300 flex items-center justify-between shadow-md group/collapsed"
                    >
                        <div class="flex items-center gap-3 text-zinc-600 dark:text-zinc-300 text-sm">
                            ...
                            <span class="font-medium group-hover/collapsed:text-zinc-900 dark:group-hover/collapsed:text-white transition-colors">How Playlists Work: Curation, Recommendations & Spotify Syncing</span>
                        </div>
                        <span class="text-zinc-400 dark:text-zinc-500 group-hover/collapsed:text-zinc-600 dark:group-hover/collapsed:text-zinc-300 transition-colors flex items-center gap-1.5 text-xs font-semibold">
                            Expand
                    ...
                    <div x-show="!isCollapsed"
                         ...
                         class="relative bg-white dark:bg-black border border-gray-200 dark:border-white/10 rounded-3xl p-6 sm:p-8 shadow-xl overflow-hidden group/banner"
                    >
                        ...
                        <button @click="isCollapsed = true; localStorage.setItem('playlistOnboardingCollapsed', 'true')" 
                                class="absolute top-4 right-4 text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-zinc-800/50 p-1.5 rounded-lg transition-all duration-200 z-10 flex items-center gap-1.5 text-xs font-semibold"
                        ...
                        <div class="relative z-10">
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-2">Get the most out of Playlists</h3>
                            <p class="text-sm text-zinc-500 dark:text-zinc-300 mb-6 max-w-2xl">Collaborate, shape your recommendation DNA, and take your music anywhere with Reso and Spotify synchronization.</p>

                            <!-- Pillars Grid -->
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <!-- Pillar 1: Curate Shared Vibes -->
                                <div class="bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-white/5 rounded-2xl p-5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-gray-100/50 dark:hover:bg-gray-900 transition-all duration-300 flex flex-col items-start">
                                    <div class="bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-600 dark:text-indigo-400 p-2.5 rounded-xl mb-4 transition-transform duration-300 hover:scale-110">
                                    ...
                                    <h4 class="text-base font-bold text-zinc-900 dark:text-white mb-2">Curate Shared Vibes</h4>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-300 leading-relaxed">Easily build and organize soundtracks with your friends. Invite mutual followers to collaborate and curate the perfect playlist together in real time.</p>
                                </div>

                                <!-- Pillar 2: Shape Your Recommendations -->
                                <div class="bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-white/5 rounded-2xl p-5 hover:border-fuchsia-500/30 dark:hover:border-fuchsia-500/30 hover:bg-gray-100/50 dark:hover:bg-gray-900 transition-all duration-300 flex flex-col items-start">
                                    <div class="bg-fuchsia-50 dark:bg-fuchsia-500/10 border border-fuchsia-100 dark:border-fuchsia-500/20 text-fuchsia-600 dark:text-fuchsia-400 p-2.5 rounded-xl mb-4 transition-transform duration-300 hover:scale-110">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                    ...
                                    <h4 class="text-base font-bold text-zinc-900 dark:text-white mb-2">Shape Your Recommendations</h4>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-300 leading-relaxed">The music you add to your playlists teaches the platform what you love. It automatically refines your personal music taste to recommend better matches on your Discovery feed.</p>
                                </div>

                                <!-- Pillar 3: Sync with Spotify -->
                                <div class="bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-white/5 rounded-2xl p-5 hover:border-emerald-500/30 dark:hover:border-emerald-500/30 hover:bg-gray-100/50 dark:hover:bg-gray-900 transition-all duration-300 flex flex-col items-start">
                                    <div class="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 p-2.5 rounded-xl mb-4 transition-transform duration-300 hover:scale-110">
                                    ...
                                    <h4 class="text-base font-bold text-zinc-900 dark:text-white mb-2">Sync with Spotify</h4>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-300 leading-relaxed">Seamlessly import your playlists from Spotify, or export your curated Reso playlists back to your Spotify library to take your music anywhere.</p>
                                </div>
                            </div>
                        </div>
                    </div>
