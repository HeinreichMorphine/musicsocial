                                    ...
                                    <div class="flex gap-2">
                                        <div class="relative group flex-1 sm:w-64">
                                            <input type="text" x-model="search" @input.debounce.300ms="if(search.length > 2) searchGlobal()"
                                                   class="w-full bg-gray-100 dark:bg-white/5 border-none text-xs font-bold text-gray-900 dark:text-white rounded-xl px-10 py-3 focus:ring-2 focus:ring-emerald-500 transition" 
