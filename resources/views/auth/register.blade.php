                        ...
                        <div class="space-y-3 mb-6">
                            <div class="flex items-start gap-3 p-3.5 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-500/20">
                                ...
                                <p class="text-xs text-amber-800 dark:text-amber-300/90 leading-relaxed">
                                    <strong class="text-amber-900 dark:text-amber-200">Not on the allowlist?</strong> Your Spotify sign-up will be rejected. Please register with Google or Email instead.
                                </p>
                            </div>
