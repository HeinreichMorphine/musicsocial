<x-guest-layout>
    ...
    <div class="mb-8 text-center">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white transition-colors">Welcome Back</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 transition-colors">Enter your credentials to access your account</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6" novalidate>
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white leading-tight" id="spotify-modal-title">Spotify Login Restricted</h3>
                            </div>
                        </div>

                        <!-- Explanation -->
                        <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                            Due to Spotify's new <strong class="text-gray-800 dark:text-gray-200">B2B API policy</strong>, our Spotify integration is in a closed development mode. Only manually approved accounts can sign in via Spotify.
                        </p>
        ...
        <div class="flex items-center gap-3 my-5">
            ...
            <span class="text-xs font-bold text-custom-slate-blue dark:text-gray-500 uppercase tracking-wider">Or continue with email</span>
            <div class="flex-1 h-px bg-slate-200 dark:bg-white/10"></div>
        </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <input id="remember_me" type="checkbox" class="h-4.5 w-4.5 text-custom-mid-blue focus:ring-custom-mid-blue/30 border-slate-300 dark:border-white/10 dark:bg-white/5 rounded-lg" name="remember">
                <label for="remember_me" class="ml-2 block text-sm text-slate-600 dark:text-slate-400 font-medium select-none cursor-pointer">
                    {{ __('Remember me') }}
                </label>
            </div>
