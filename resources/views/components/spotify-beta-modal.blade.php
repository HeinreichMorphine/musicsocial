        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div x-show="showSpotifyBetaModal"
                 ...
                 x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                  class="relative transform overflow-hidden rounded-[2rem] bg-white dark:bg-[#181818] text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-md border border-gray-100 dark:border-white/10">
                ...
                <div class="px-6 pb-6 pt-8 sm:p-8">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white leading-tight">Spotify Login Restricted</h3>
                        </div>
                    </div>

                    <!-- Intro Text -->
                    <p class="text-[15px] text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                    ...
                    <div class="space-y-3 mb-6">
                        <!-- Warning Box -->
                        <div class="flex items-start gap-3 p-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5">
                        ...
                        <!-- Info Box -->
                        <div class="flex items-start gap-3 p-4 rounded-2xl border border-blue-100 dark:border-blue-800/30 bg-blue-50/50 dark:bg-blue-900/20">
                            <div class="shrink-0 mt-0.5">
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                                <strong class="text-gray-900 dark:text-white font-semibold">Want access?</strong> Email <a href="mailto:adamakib507@gmail.com" class="font-bold text-blue-600 dark:text-blue-400 hover:underline transition-colors">adamakib507@gmail.com</a> to request whitelist approval.
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Actions -->
                    <div class="space-y-3">
                        <a href="{{ route('social.redirect', 'google') }}" class="w-full flex items-center justify-center gap-3 bg-[#0F172A] dark:bg-white hover:bg-black dark:hover:bg-gray-100 text-white dark:text-black px-6 py-3.5 rounded-xl text-[15px] font-bold transition-all shadow-lg shadow-gray-900/10">
                        ...
                        <button type="button" @click="showSpotifyBetaModal = false" class="w-full flex items-center justify-center px-6 py-3 text-[15px] font-bold text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors">
                            Go back
                        </button>
                    </div>

                    <div class="mt-6 pt-6 border-t border-gray-100 dark:border-white/5 text-center">
                        <a href="{{ route('social.redirect', 'spotify') }}" class="text-[13px] text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:underline transition-colors font-medium">
