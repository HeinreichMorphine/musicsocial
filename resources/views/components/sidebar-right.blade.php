<div class="bg-custom-periwinkle/50 rounded-xl shadow-lg p-5 mt-6 space-y-3">
    ...
    @if (isset($recommendedShares) && !$recommendedShares->isEmpty())
        @foreach ($recommendedShares->take(5) as $share)
            <div class="flex items-center space-x-3">
            <div class="relative" style="width: 48px; height: 48px;">
                <img class="absolute inset-0 w-full h-full object-cover rounded" src="{{ $share->album_art_url }}" alt="Album Art">
            </div>
