...
<a href="{{ $song->spotify_url }}" target="_blank" class="block bg-white shadow rounded-lg overflow-hidden mb-4 hover:shadow-xl transition-shadow duration-200">
    <div class="relative w-full" style="padding-top: 100%;">
        <img class="absolute inset-0 w-full h-full object-cover" src="{{ $song->album_art_url }}" alt="Album Art">
    </div>
    <div class="p-4">
        <h3 class="font-semibold text-lg">{{ $song->track_name }}</h3>
