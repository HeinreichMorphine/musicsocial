        ...
        <div class="flex space-x-4">
            ...
            <div class="flex-1">
                <div class="flex justify-between items-center">
                    <div>
                        <a href="{{ route('profile.show', $share->user->name) }}" x-on:click.stop class="font-bold text-gray-900 hover:text-custom-mid-blue transition-colors">{{ $share->user->name }}</a>
                    ...
                    <div class="grid grid-cols-4 gap-2 w-full mt-2">
                        ...
                        " class="flex justify-center">
                            ...
                            <button type="submit" class="flex items-center space-x-2 py-2 px-4 rounded-xl hover:bg-gray-100 transition-colors group w-full justify-center" title="Dislike">
                                ...
                                <span class="text-sm font-bold text-gray-500 group-hover:text-gray-700 transition-colors"></span>
                            </button>
                        </form>
                        @else
                ...
                <div x-on:click.stop>
                    ...
                    <div x-show="commentsOpen" x-transition class="mt-4 px-4 pl-6 border-l-2 border-gray-100" style="display: none;" x-data="{ newComment: '' }">
                        <form @submit.prevent="
                            ...
                            .then(html => {
                                let commentSection = $el.closest('.space-y-4');
