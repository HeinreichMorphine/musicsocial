            ...
            <div class="flex-1 min-w-0 w-full">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center flex-wrap gap-3 mt-2 md:mt-3">
                                ...
                                <button type="button"
                                    ...
                                    "
                                    :title="isPremium ? (isReady ? 'Play track' : 'Connecting to Spotify...') : 'Play 30s preview'"
                                    :class="isPremium && !isReady ? 'opacity-40 grayscale cursor-not-allowed' : 'hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(30,215,96,0.6)] cursor-pointer'"
                ...
                <div x-show="playerOpen"
                    ...
                    <iframe class="share-spotify-frame"
                        x-bind:src="playerOpen ? 'https://open.spotify.com/embed/track/{{ $share->song->spotify_track_id }}?utm_source=generator&theme=0' : ''"
                        width="100%"
                        height="80"
                        frameborder="0"
