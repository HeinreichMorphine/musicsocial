      ...
      tests: [
        {
          ...
          desc:
            'Steps:\n' +
            '1. In the Home feed, click the central input in the "Drop a track" composer.\n' +
            '2. Type a song name, select a track from the search dropdown, and add a caption.\n' +
            '3. Toggle the mode to "Just Sharing" and click Post.\n' +
            '4. Verify sidebar page links, follow button in "Who to Follow" sidebar, and "Explore" vs "Following" feed tabs.\n\n' +
